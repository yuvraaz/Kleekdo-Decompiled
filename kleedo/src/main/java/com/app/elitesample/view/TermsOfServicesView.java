...
public class TermsOfServicesView
  ...
  implements View.OnClickListener
{
  private void initUIView(View paramView)
  {
    ...
    this.topBarTitleTxt.setText("Terms of Service");
...
/* Location:              D:\dex2jar-2.0\classes-dex2jar.jar!\com\app\elitesample\view\TermsOfServicesView.class
